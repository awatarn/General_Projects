...
/*
*  Content:
*  C real example of solving 3D Laplace problem in a
...
/* Failure message to print if something went wrong */
	...
	if(error != 0)
	{
		printf("\nSingle precision 3D Laplace example FAILED to compute ");
		printf("the solution...\n");
		return 1;
	}
  /* Success message to print if everything is OK */
  printf("\n Single precision 3D Laplace example has successfully PASSED\n");
