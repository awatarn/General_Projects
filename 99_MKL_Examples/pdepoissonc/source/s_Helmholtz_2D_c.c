...
/*
*  Content:
*  C float example of solving 2D Helmholtz problem in a
...
int main(void)
{
  ...
  /* Failure message to print if something went wrong */
	...
	if(error != 0)
	{
		 printf("\nSingle precision 2D Helmholtz example FAILED to compute ");
         printf("the solution...\n");
         return 1;
	}
  /* Success message to print if everything is OK */
  printf("\n Single precision 2D Helmholtz example has successfully PASSED\n");
