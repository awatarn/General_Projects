...
#define INDIA 12
    ...
    MKL_Complex16   Adns[MN];
    MKL_Complex16   Adns_standard[MN];
    MKL_Complex16   Absr[NZMAX];
    MKL_Complex16   Absr_standard[NZMAX]      =  { {5.0, 1.0}, {9.0, 1.0}, {8.0, 1.0}, {2.0, 1.0}, {3.0, 1.0}, {1.0, 1.0}, {6.0, 1.0}, {4.0, 1.0} };
    MKL_Complex16   Acsr[NZMAX];
    MKL_Complex16   Acsr_standard[NZMAX]      =  { {5.0, 1.0}, {8.0, 1.0}, {9.0, 1.0}, {2.0, 1.0}, {3.0, 1.0}, {6.0, 1.0}, {1.0,1.0}, {4.0, 1.0} };
    MKL_Complex16   Acsc[NZMAX];
    MKL_Complex16   Acsc_standard[NZMAX]      =  { {5.0, 1.0}, {9.0, 1.0}, {8.0, 1.0}, {2.0, 1.0}, {3.0, 1.0}, {1.0, 1.0}, {6.0, 1.0}, {4.0, 1.0} };
    MKL_Complex16   Adia[INDIA];
    MKL_Complex16   Adia_standard[INDIA]      =  { {0.0, 0.0}, {9.0, 1.0}, {0.0, 0.0}, {1.0, 1.0}, {5.0, 1.0}, {2.0, 1.0}, {3.0, 1.0}, {4.0, 1.0}, {8.0, 1.0}, {0.0, 0.0}, {6.0, 1.0}, {0.0, 0.0} };
    MKL_Complex16   Asky[6];
    MKL_Complex16   Askyl_standard[6]          =  { {5.0, 1.0}, {9.0, 1.0}, {2.0, 1.0}, {3.0, 1.0}, {1.0, 1.0}, {4.0, 1.0} };
    MKL_Complex16   Acoo[NZMAX];
    MKL_Complex16   Acoo_standard[NZMAX]      =  { {5.0, 1.0}, {8.0, 1.0}, {9.0, 1.0}, {2.0, 1.0}, {3.0, 1.0}, {6.0, 1.0}, {1.0, 1.0}, {4.0, 1.0} };
    MKL_Complex16   CZERO = {0.0, 0.0};
    MKL_INT     AI[M+1];
    MKL_INT     AI1[M+1];
...
//***************************************************************************************************
    ...
    mkl_zdnscsr(job, &m, &n, Adns, &lda, Acsr, AJ, AI, &info);
...
//***************************************************************************************************
    job[0]=0;
    job[5]=3;
    mkl_zcsrcoo (job, &n, Acsr, AJ, AI, &nnz, Acoo, ir, jc, &info);
...
//***************************************************************************************************
    ...
    job[2] = 1;
    job[5] = 1;
    mkl_zcsrbsr(job, &m, &mblk, &ldAbsr, Acsr, AJ, AI, Absr, AJB, AIB, &info);
...
//***************************************************************************************************
    ...
    job[0] = 1;
    job[5] = 3;
    mkl_zcsrbsr(job, &nn, &mblk, &ldAbsr, Acsr, AJ, AI, Absr, AJB, AIB, &info);
...
//***************************************************************************************************
    ...
    job[0] = 0;
    job[5] = 0;
    mkl_zcsrdia(job, &n, Acsr, AJ, AI, Adia, &ndiag, distance, &idiag, Acsr, AJ, AI, &info);
...
//***************************************************************************************************
    ...
    mkl_zcsrcsc(job, &n, Acsr, AJ, AI, Acsc, AJ1, AI1, &info);
...
//***************************************************************************************************
    ...
    mkl_zcsrsky(job, &n, Acsr, AJ, AI, Asky, pointers, &info);
