...
!          MKL_CSPBLAS_DCSRSYMV where S is a vector.
...
//*******************************************************************************
    ...
    double      values1[NNZ1] ={1.0, -2.0, 5.0, 4.0,  -4.0, 2.0, 7.0,  8.0, -5.0};
...
//    and solve triangular system   (L+D)' *temp = rhs
...
//              the help of mkl_cspblas_dcsrsymv
// NOTE: The routine mkl_cspblas_dcsrsymv as well as the similar dense Level 2
...
//
//   values1[9]={1.0, -2.0, 5.0, 4.0,  -4.0, 2.0, 7.0,  8.0, -5.0},
...
//  mkl_cspblas_dcsrsymv(&uplo, &m, values1, rowIndex1, columns1, sol_vec, temp_vec);
//
...
printf("   MKL_CSPBLAS_DCSRSYMV  CALLED TWO TIMES \n");
    for (i = 0; i < m; i++) {
        printf("%7.1f     %7.1f\n", rhs_vec[i], temp_vec[i]);
    };
    printf("-----------------------------------------------\n");
//*******************************************************************************
// Task 6.   Obtain matrix-vector multiply A'*sol --> rhs with
//              the help of  mkl_cspblas_dcsrgemv
//*******************************************************************************
    printf("                             \n");
