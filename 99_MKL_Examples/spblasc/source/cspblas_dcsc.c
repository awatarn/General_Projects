...
#define MNEW 3
    ...
    double      values[NNZ]   = {1.0, -2.0, -4.0, -1.0, 5.0, 8.0, 4.0, 2.0, -3.0, 6.0, 7.0, 4.0, -5.0};
...
//*******************************************************************************
    printf("                             \n");
    printf("   INPUT DATA FOR MKL_DCSCMM \n");
    ...
    mkl_dcscmm(&transa, &m, &n, &m, &alpha, matdescra, values, rows, colIndex, &(colIndex[1]), &(sol[0][0]), &n,  &beta, &(rhs[0][0]), &n);

    printf("                             \n");
    printf("   OUTPUT DATA FOR MKL_DCSCMM\n");
    printf("   WITH TRIANGULAR MATRIX    \n");
    for (i = 0; i < m; i++) {
        for (j = 0; j < n; j++) {
            printf("%7.1f", rhs[i][j]);
    ...
    mkl_dcscsm(&transa, &m, &n, &alpha, matdescra, values, rows, colIndex, &(colIndex[1]), &(rhs[0][0]), &n, &(temp[0][0]), &n);

    printf("                             \n");
    printf("   OUTPUT DATA FOR MKL_DCSCSM\n");
    for (i = 0; i < m; i++) {
        for (j = 0; j < n; j++) {
...
//*******************************************************************************
    ...
    printf("                             \n");
    printf("   INPUT DATA FOR MKL_DCSCMV \n");
    printf("   WITH TRIANGULAR MATRIX    \n");
    printf("     ALPHA = %4.1f  BETA = %4.1f \n", alpha, beta);
    printf("     TRANS = '%c' \n", 'T');
    printf("   Input vector              \n");
    ...
    mkl_dcscmv(&transa, &m, &m, &alpha, matdescra, values, rows, pointerB, pointerE, sol_vec, &beta, rhs_vec);

    printf("                             \n");
    printf("   OUTPUT DATA FOR MKL_DCSCMV\n");
    printf("   WITH TRIANGULAR MATRIX    \n");
    for (i = 0; i < m; i++) {
        printf("%7.1f\n", rhs_vec[i]);
    };
    ...
    mkl_dcscsv(&transa, &m, &alpha, matdescra, values, rows, colIndex, &(colIndex[1]),  rhs_vec, temp_vec);
...
//*******************************************************************************
    ...
    printf("   of MKL_DCSCSV            \n");


    mkl_dcscsv(&transa, &m, &alpha, matdescra, values, rows, colIndex, &(colIndex[1]), rhs_vec, temp_vec);

    printf("                             \n");
    printf("   OUTPUT DATA FOR MKL_DCSCSV\n");
    printf("   WITH DIAGONAL MATRIX      \n");
    for (i = 0; i < m; i++) {
        printf("%7.1f\n", temp_vec[i]);
    };
...
//*******************************************************************************
    ...
    matdescra[2] = 'n';
    matdescra[3] = 'c';
    mkl_dcscmv(&transa, &m, &m, &alpha, matdescra, values, rows, colIndex, &(colIndex[1]), sol_vec, &beta, rhs_vec);
    printf("                             \n");
...
//*******************************************************************************
    ...
    printf("-----------------------------------------------\n");
//*******************************************************************************
// Task 6.   Obtain matrix-vector multiply A'*sol --> rhs with the help of MKL_DCSCMV
//
//*******************************************************************************
    printf("                             \n");
    printf("   INPUT DATA FOR            \n");
...
//*******************************************************************************
// Task 7.  Obtain matrix-vector multiply T*sol --> rhs with the help of MKL_DCSCMV
...
//*******************************************************************************
    ...
    mkl_dcscmv(&transa, &mnew, &mnew, &alpha, matdescra, values, rows, pointerB, pointerE, sol_vec, &beta, rhs_vec);
    ...
    mkl_dcscsv(&transa, &mnew, &alpha, matdescra, values, rows, pointerB, pointerE, rhs_vec, temp_vec);
