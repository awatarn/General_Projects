...
/* input matrix stored in BSR format */
/* -------------------------------------------------------------------- */
...
MKL_INT main (void)
{
    /* Matrix data. */
    MKL_INT n = 6;
    MKL_INT block_size = 2;
    MKL_INT ia[7] = { 1, 4, 7, 8, 9, 11, 12};
    MKL_INT ja[11] = 
    { 1,    3,       6,
         2, 3,    5,
            3,
    ...
    double a[11*4] = 
    { 7.0,1.0,2.0,2.0 ,     7.0,0.0,3.0,1.0,     2.0,6.0,1.0,11.0,
      8.0,3.0,2.0,20.0,     9.0,4.0,1.0,9.0,     12.0,2.0,0.0,1.0,
      10.0,3.0,7.0,12.0,
      12.0,2.0,5.0,11.0,
      1.0,2.0,0.0,1.0,      17.0,0.0,3.0,2.0,
      4.0,7.0,2.0,3.0,
    };
