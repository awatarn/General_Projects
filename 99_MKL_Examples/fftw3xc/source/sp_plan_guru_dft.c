...
/*
! Content:
!       Example of using fftwf_plan_guru_dft function.
!
!****************************************************************************/
...
static void init_i(fftwf_complex *x, fftwf_iodim *ndims, fftwf_iodim *vdims,
                   int H1, int H2, int H3);
static int verify_o(fftwf_complex *x, fftwf_iodim *ndims, fftwf_iodim *vdims,
                    int H1, int H2, int H3);
...
int main(void)
{
    ...
    printf("Example sp_plan_guru_dft\n");
    ...
    fwd = fftwf_plan_guru_dft(3, dim, 1, &M_dim, x, y, FFTW_FORWARD,
                             FFTW_ESTIMATE);
    if (0 == fwd) goto failed;

    printf("Create FFTW plan for backward transform\n");
    swapio2(3,dim,1,&M_dim);
    bwd = fftwf_plan_guru_dft(3, dim, 1, &M_dim, y, x, FFTW_BACKWARD,
                             FFTW_ESTIMATE);
