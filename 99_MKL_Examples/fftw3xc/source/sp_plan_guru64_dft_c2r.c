...
/*
! Content:
!       Example of using fftwf_plan_guru64_dft_c2r function.
!
!****************************************************************************/
...
int main(void)
{
    ...
    printf("Example sp_plan_guru64_dft_c2r\n");
    ...
    y  = fftwf_malloc(sizeof(float) * nr );
    ...
    printf("Create FFTW plan for c2r transform\n");
    {
        ...
        c2r = fftwf_plan_guru64_dft_c2r(3, dim, 1, &M_dim, x, y, FFTW_ESTIMATE);
    ...
    printf("Create FFTW plan for r2c transform\n");
    {
        ...
        r2c = fftwf_plan_guru64_dft_r2c(3, dim, 1, &M_dim, y, x, FFTW_ESTIMATE);
