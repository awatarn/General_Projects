...
/*
!  Content:
!    vslzConvNewTaskX  Example Program Text
!******************************************************************************/
...
int main()
{
    VSLConvTaskPtr task;
    int status,ok;
    MKL_INT mode,rank,xshape,yshape,zshape,xstride;
    static MKL_Complex16 x[100];
    ...
    xstride = 1;
    status = vslzConvNewTaskX(&task,mode,rank,&xshape,&yshape,&zshape,
        x,&xstride);
