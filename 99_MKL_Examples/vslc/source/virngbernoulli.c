...
/*
!  Content:
!    viRngBernoulli  Example Program Text
!******************************************************************************/
...
#define METHOD  VSL_RNG_METHOD_BERNOULLI_ICDF
#define N       1000
#define NN      10
...
int main()
{
    ...
    /***** Call RNG *****/
    errcode = viRngBernoulli( METHOD, stream, N, r, p );
    CheckVslError( errcode );
    ...
    /***** Printing results *****/
    printf("Sample of viRngBernoulli.\n");
    printf("-------------------------\n\n");
    printf("Parameters:\n");
    printf("    p=%.4f\n",p);
