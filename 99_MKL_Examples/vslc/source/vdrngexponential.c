...
/*
!  Content:
!    vdRngExponential  Example Program Text
!******************************************************************************/
...
#define METHOD  VSL_RNG_METHOD_EXPONENTIAL_ICDF
#define N       1000
#define NN      10
...
int main()
{
    ...
    /***** Call RNG *****/
    errcode = vdRngExponential( METHOD, stream, N, r, a, beta );
    CheckVslError( errcode );
    ...
    /***** Printing results *****/
    printf("Sample of vdRngExponential.\n");
    printf("---------------------------\n\n");
    printf("Parameters:\n");
    printf("    a=%.4f\n",a);
    printf("    beta=%.4f\n\n",beta);
