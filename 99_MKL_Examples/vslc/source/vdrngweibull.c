...
/*
!  Content:
!    vdRngWeibull  Example Program Text
!******************************************************************************/
...
#define METHOD  VSL_RNG_METHOD_WEIBULL_ICDF
#define N       1000
#define NN      10
...
int main()
{
    ...
    int i, errcode;
    double alpha=1.0,a=0.0,beta=1.0;
    ...
    /***** Call RNG *****/
    errcode = vdRngWeibull( METHOD, stream, N, r, alpha, a, beta );
    CheckVslError( errcode );
