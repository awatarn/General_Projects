...
/*
 ...
 LAPACKE_dsysv (row-major, high-level) Example Program Results
...
int main() {
	...
	printf( "LAPACKE_dsysv (row-major, high-level) Example Program Results\n" );
	/* Solve the equations A*X = B */
	info = LAPACKE_dsysv( LAPACK_ROW_MAJOR, 'L', n, nrhs, a, lda, ipiv,
			b, ldb );
