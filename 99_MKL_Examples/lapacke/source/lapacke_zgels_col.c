...
/*
 ...
 LAPACKE_zgels (column-major, high-level) Example Program Results
...
int main() {
	...
	printf( "LAPACKE_zgels (column-major, high-level) Example Program Results\n" );
	/* Solve the equations A*X = B */
	info = LAPACKE_zgels( LAPACK_COL_MAJOR, 'N', m, n, nrhs, a, lda, b, ldb );
