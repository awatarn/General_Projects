...
/*
 ...
 LAPACKE_cgesvd (row-major, high-level) Example Program Results
...
int main() {
	...
	MKL_Complex8 a[LDA*M] = {
	   { 5.91f, -5.69f}, { 7.09f,  2.72f}, { 7.78f, -4.06f}, {-0.79f, -7.21f},
	   {-3.15f, -4.08f}, {-1.89f,  3.27f}, { 4.57f, -2.07f}, {-3.88f, -3.30f},
	   {-4.89f,  4.20f}, { 4.10f, -6.70f}, { 3.28f, -3.84f}, { 3.84f,  1.19f}
	};
	/* Executable statements */
	printf( "LAPACKE_cgesvd (row-major, high-level) Example Program Results\n" );
	/* Compute SVD */
	info = LAPACKE_cgesvd( LAPACK_ROW_MAJOR, 'A', 'A', m, n, a, lda, s,
