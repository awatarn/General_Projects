...
/*
 ...
 LAPACKE_cheevd (row-major, high-level) Example Program Results
...
int main() {
	...
	MKL_Complex8 a[LDA*N] = {
	   { 3.40f,  0.00f}, { 0.00f,  0.00f}, { 0.00f,  0.00f}, { 0.00f,  0.00f},
	   {-2.36f,  1.93f}, { 6.94f,  0.00f}, { 0.00f,  0.00f}, { 0.00f,  0.00f},
	   {-4.68f, -9.55f}, { 8.13f,  1.47f}, {-2.14f,  0.00f}, { 0.00f,  0.00f},
	   { 5.37f,  1.23f}, { 2.07f,  5.78f}, { 4.68f, -7.44f}, {-7.42f,  0.00f}
	};
	/* Executable statements */
	printf( "LAPACKE_cheevd (row-major, high-level) Example Program Results\n" );
	/* Solve eigenproblem */
	info = LAPACKE_cheevd( LAPACK_ROW_MAJOR, 'V', 'L', n, a, lda, w );
