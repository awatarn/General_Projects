...
/*
 ...
 LAPACKE_dposv (column-major, high-level) Example Program Results
...
int main() {
	...
	printf( "LAPACKE_dposv (column-major, high-level) Example Program Results\n" );
	/* Solve the equations A*X = B */
	info = LAPACKE_dposv( LAPACK_COL_MAJOR, 'U', n, nrhs, a, lda, b, ldb );
