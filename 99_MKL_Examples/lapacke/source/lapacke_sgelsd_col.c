...
/*
 ...
 LAPACKE_sgelsd (column-major, high-level) Example Program Results
...
int main() {
	...
	printf( "LAPACKE_sgelsd (column-major, high-level) Example Program Results\n" );
	/* Solve the equations A*X = B */
	info = LAPACKE_sgelsd( LAPACK_COL_MAJOR, m, n, nrhs, a, lda, b, ldb,
			s, rcond, &rank );
