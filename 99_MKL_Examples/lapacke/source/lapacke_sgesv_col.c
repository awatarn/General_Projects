...
/*
 ...
 LAPACKE_sgesv (column-major, high-level) Example Program Results
...
int main() {
	...
	printf( "LAPACKE_sgesv (column-major, high-level) Example Program Results\n" );
	/* Solve the equations A*X = B */
	info = LAPACKE_sgesv( LAPACK_COL_MAJOR, n, nrhs, a, lda, ipiv,
			b, ldb );
