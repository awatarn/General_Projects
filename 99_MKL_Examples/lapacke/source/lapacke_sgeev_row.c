...
/*
 ...
 LAPACKE_sgeev (row-major, high-level) Example Program Results
...
int main() {
	...
	printf( "LAPACKE_sgeev (row-major, high-level) Example Program Results\n" );
	/* Solve eigenproblem */
	info = LAPACKE_sgeev( LAPACK_ROW_MAJOR, 'V', 'V', n, a, lda, wr, wi,
			vl, ldvl, vr, ldvr );
