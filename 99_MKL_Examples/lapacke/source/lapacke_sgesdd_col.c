...
/*
 ...
 LAPACKE_sgesdd (column-major, high-level) Example Program Results
...
int main() {
	...
	printf( "LAPACKE_sgesdd (column-major, high-level) Example Program Results\n" );
	/* Compute SVD */
	info = LAPACKE_sgesdd( LAPACK_COL_MAJOR, 'S', m, n, a, lda, s,
			u, ldu, vt, ldvt );
