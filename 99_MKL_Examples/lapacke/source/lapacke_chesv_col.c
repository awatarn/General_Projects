...
/*
 ...
 LAPACKE_chesv (column-major, high-level) Example Program Results
...
int main() {
	...
	printf( "LAPACKE_chesv (column-major, high-level) Example Program Results\n" );
	/* Solve the equations A*X = B */
	info = LAPACKE_chesv( LAPACK_COL_MAJOR, 'U', n, nrhs, a, lda, ipiv,
			b, ldb );
