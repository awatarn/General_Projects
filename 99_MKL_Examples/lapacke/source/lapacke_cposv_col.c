...
/*
 ...
 LAPACKE_cposv (column-major, high-level) Example Program Results
...
int main() {
	...
	MKL_Complex8 a[LDA*N] = {
	   ...
	   { 0.00f,  0.00f}, { 7.95f,  0.00f}, { 0.33f, -0.09f}, { 0.22f, -0.74f},
	   { 0.00f,  0.00f}, { 0.00f,  0.00f}, { 4.43f,  0.00f}, {-1.09f, -0.32f},
	   { 0.00f,  0.00f}, { 0.00f,  0.00f}, { 0.00f,  0.00f}, { 3.46f,  0.00f}
	};
	...
	printf( "LAPACKE_cposv (column-major, high-level) Example Program Results\n" );
	/* Solve the equations A*X = B */
	info = LAPACKE_cposv( LAPACK_COL_MAJOR, 'L', n, nrhs, a, lda, b, ldb );
