...
/*
 ...
 LAPACKE_ssyevr (column-major, high-level) Example Program Results
...
int main() {
	...
	printf( "LAPACKE_ssyevr (column-major, high-level) Example Program Results\n" );
	...
	iu = NSELECT;
	/* Solve eigenproblem */
	info = LAPACKE_ssyevr( LAPACK_COL_MAJOR, 'V', 'I', 'U', n, a, lda,
