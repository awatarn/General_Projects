...
/*
 ...
 LAPACKE_sposv (row-major, high-level) Example Program Results
...
int main() {
	...
	/* Local arrays */
	float a[LDA*N] = {
	    3.14f,  0.17f, -0.90f, 1.65f, -0.72f,
	    0.00f,  0.79f,  0.83f, -0.65f,  0.28f,
	    0.00f,  0.00f,  4.53f, -3.70f,  1.60f,
	    0.00f,  0.00f,  0.00f, 5.32f, -1.37f,
	    0.00f,  0.00f,  0.00f, 0.00f,  1.98f
	};
	float b[LDB*N] = {
	   -7.29f,  6.11f,  0.59f,
	    9.25f,  2.90f,  8.88f,
	...
	info = LAPACKE_sposv( LAPACK_ROW_MAJOR, 'U', n, nrhs, a, lda, b, ldb );
