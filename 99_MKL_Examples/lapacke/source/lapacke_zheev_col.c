...
/*
 ...
 LAPACKE_zheev (column-major, high-level) Example Program Results
...
int main() {
	...
	printf( "LAPACKE_zheev (column-major, high-level) Example Program Results\n" );
	/* Solve eigenproblem */
	info = LAPACKE_zheev( LAPACK_COL_MAJOR, 'V', 'L', n, a, lda, w );
