...
/*
 ...
 LAPACKE_dgelsd (column-major, high-level) Example Program Results
...
int main() {
	...
	printf( "LAPACKE_dgelsd (column-major, high-level) Example Program Results\n" );
	/* Solve the equations A*X = B */
	info = LAPACKE_dgelsd( LAPACK_COL_MAJOR, m, n, nrhs, a, lda, b, ldb,
			s, rcond, &rank );
