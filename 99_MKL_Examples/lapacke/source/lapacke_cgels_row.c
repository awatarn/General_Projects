...
/*
 ...
 LAPACKE_cgels (row-major, high-level) Example Program Results
...
int main() {
	...
	MKL_Complex8 a[LDA*M] = {
	   {-4.20f, -3.44f}, {-3.35f,  1.52f}, { 1.73f,  8.85f}, { 2.35f,  0.34f},
	   {-5.43f, -8.81f}, {-4.53f, -8.47f}, { 5.93f,  3.75f}, {-3.75f, -5.66f},
	   {-5.56f,  3.39f}, { 2.90f, -9.22f}, { 8.03f,  9.37f}, { 5.69f, -0.47f}
	};
	MKL_Complex8 b[LDB*N] = {
	   {-7.02f,  4.80f}, { 3.88f, -2.59f},
	   { 0.62f, -2.40f}, { 1.57f,  3.24f},
	   { 3.10f, -2.19f}, {-6.93f, -5.99f},
	   { 0.00f,  0.00f}, { 0.00f,  0.00f}
	};
	/* Executable statements */
	printf( "LAPACKE_cgels (row-major, high-level) Example Program Results\n" );
	/* Solve the equations A*X = B */
	info = LAPACKE_cgels( LAPACK_ROW_MAJOR, 'N', m, n, nrhs, a, lda, b, ldb );
