...
/*
 ...
 LAPACKE_cheevx (row-major, high-level) Example Program Results
...
int main() {
	...
	MKL_Complex8 a[LDA*N] = {
	   { 6.51f,  0.00f}, { 0.00f,  0.00f}, { 0.00f,  0.00f}, { 0.00f,  0.00f},
	   {-5.92f, -9.53f}, {-1.73f,  0.00f}, { 0.00f,  0.00f}, { 0.00f,  0.00f},
	   {-2.46f, -2.91f}, { 6.50f, -2.09f}, { 6.90f,  0.00f}, { 0.00f,  0.00f},
	   { 8.84f, -3.21f}, { 1.32f, -8.81f}, {-0.59f, -2.47f}, {-2.85f,  0.00f}
	};
	/* Executable statements */
	printf( "LAPACKE_cheevx (row-major, high-level) Example Program Results\n" );
	...
	vu = 100.0;
	/* Solve eigenproblem */
	info = LAPACKE_cheevx( LAPACK_ROW_MAJOR, 'V', 'V', 'L', n, a, lda,
