...
int main(void)  /* COMPLEX_1D_EX6 */
{
    ...
    */
    my_plan = fftw_create_plan_specific(n, FFTW_FORWARD, FFTW_ESTIMATE,
    ...
    */
    my_plan = fftw_create_plan_specific(n, FFTW_BACKWARD, FFTW_ESTIMATE,
