...
int main(void)  /* REAL_2D_EX1 */
{
    ...
    */
    my_plan = rfftw2d_create_plan(m, n, FFTW_REAL_TO_COMPLEX, FFTW_ESTIMATE | FFTW_IN_PLACE);
    DIE_UNLESS(my_plan);
    ...
    */
    my_plan = rfftw2d_create_plan(m, n, FFTW_COMPLEX_TO_REAL, FFTW_ESTIMATE | FFTW_IN_PLACE);
    DIE_UNLESS(my_plan);
