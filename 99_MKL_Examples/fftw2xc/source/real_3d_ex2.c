...
int main(void)  /* REAL_3D_EX2 */
{
    ...
    */
    my_plan = rfftw3d_create_plan(m, n, k, FFTW_REAL_TO_COMPLEX, FFTW_ESTIMATE);
    DIE_UNLESS(my_plan);
    ...
    */
    my_plan = rfftw3d_create_plan(m, n, k, FFTW_COMPLEX_TO_REAL, FFTW_ESTIMATE);
    DIE_UNLESS(my_plan);
