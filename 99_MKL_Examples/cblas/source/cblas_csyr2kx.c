...
/*
!  Content:
!      C B L A S _ C S Y R 2 K  Example Program Text ( C Interface )
!******************************************************************************/
...
int main(int argc, char *argv[])
{
      ...
      printf("\n     C B L A S _ C S Y R 2 K  EXAMPLE PROGRAM\n");
...
/*      Call CBLAS_CSYR2K subroutine ( C Interface )           */

      cblas_csyr2k(layout, uplo, trans, n, k, &alpha, a, lda,
                   b, ldb, &beta, c, ldc);
