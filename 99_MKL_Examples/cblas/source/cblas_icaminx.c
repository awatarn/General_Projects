...
/*
!  Content:
!      C B L A S _ I C A M I N   Example Program Text ( C Interface )
!******************************************************************************/
...
int main(int argc, char *argv[])
{
      ...
      printf("\n     C B L A S _ I C A M I N  EXAMPLE PROGRAM\n");
...
/*      Call CBLAS_ICAMIN subroutine ( C Interface )           */

      index = cblas_icamin(n, x, incx);
