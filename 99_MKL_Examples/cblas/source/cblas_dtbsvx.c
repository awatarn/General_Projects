...
/*
!  Content:
!      C B L A S _ D T B S V  Example Program Text ( C Interface )
!******************************************************************************/
...
int main(int argc, char *argv[])
{
      ...
      printf("\n     C B L A S _ D T B S V  EXAMPLE PROGRAM\n");
...
/*       Get input data                                       */
      ...
      if( GetBandArrayD(in_file, &layout, kl, ku, n, n, a, lda) != 0 ) {
...
/*       Print input data                                      */
      ...
      PrintBandArrayD(&layout, SHORTPRINT, kl, ku, n, n, a, lda, "A");

/*      Call CBLAS_DTBSV subroutine ( C Interface )            */
