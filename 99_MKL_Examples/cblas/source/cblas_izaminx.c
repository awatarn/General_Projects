...
/*
!  Content:
!      C B L A S _ I Z A M I N   Example Program Text ( C Interface )
!******************************************************************************/
...
int main(int argc, char *argv[])
{
      ...
      printf("\n     C B L A S _ I Z A M I N  EXAMPLE PROGRAM\n");
...
/*      Call CBLAS_IZAMIN subroutine ( C Interface )           */

      index = cblas_izamin(n, x, incx);
