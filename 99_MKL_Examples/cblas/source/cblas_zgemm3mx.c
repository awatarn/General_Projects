...
/*
!  Content:
!      C B L A S _ Z G E M M 3 M  Example Program Text ( C Interface )
!******************************************************************************/
...
int main(int argc, char *argv[])
{
      ...
      printf("\n     C B L A S _ Z G E M M 3 M  EXAMPLE PROGRAM\n");
...
/*      Call ZGEMM3M subroutine ( C Interface )                  */

      cblas_zgemm3m(layout, transA, transB, m, n, k, &alpha,
