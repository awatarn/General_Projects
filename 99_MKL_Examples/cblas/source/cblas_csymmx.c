...
/*
!  Content:
!      C B L A S _ C S Y M M  Example Program Text ( C Interface )
!******************************************************************************/
...
int main(int argc, char *argv[])
{
      ...
      printf("\n     C B L A S _ C S Y M M  EXAMPLE PROGRAM\n");
...
/*      Call CBLAS_CSYMM subroutine ( C Interface )            */

      cblas_csymm(layout, side, uplo, m, n, &alpha, a, lda,
                  b, ldb, &beta, c, ldc);
