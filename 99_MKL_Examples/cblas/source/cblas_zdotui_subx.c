...
/*
!  Content:
!      C B L A S _ Z D O T U I  Example Program Text ( C Interface )
!******************************************************************************/
...
int main(int argc, char *argv[])
{
      ...
      printf("\n     C B L A S _ Z D O T U I  EXAMPLE PROGRAM\n");
...
/*       Get input data                                        */
      ...
      if( GetVectorZ(in_file, indmax, y, 1) != indmax ) {
...
/*      Call CBLAS_ZDOTUI subroutine ( C Interface )           */

      cblas_zdotui_sub(n, x, indx, y, &res);

/*       Print output data                                     */

      printf("\n\n     OUTPUT DATA");
      printf("\n       ZDOTUI = (%6.2f,%6.2f)", res.real, res.imag);
