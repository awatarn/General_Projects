...
/*
!  Content:
!      C B L A S _ C G E M M _ B A T C H  Example Program Text ( C Interface )
!******************************************************************************/
...
int main(int argc, char *argv[])
{
      ...
      printf("\n     C B L A S _ C G E M M _ B A T C H  EXAMPLE PROGRAM\n");
...
/*      Call CGEMM_BATCH subroutine ( C Interface )                  */
      cblas_cgemm_batch(layout, transA, transB, m, n, k, alpha,
