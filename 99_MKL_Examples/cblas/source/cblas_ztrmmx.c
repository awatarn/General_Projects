...
/*
!  Content:
!      C B L A S _ Z T R M M  Example Program Text ( C Interface )
!******************************************************************************/
...
int main(int argc, char *argv[])
{
      ...
      printf("\n     C B L A S _ Z T R M M  EXAMPLE PROGRAM\n");
...
/*       Get input data                                       */
      ...
      if( GetArrayZ(in_file, &layout, typeA, &ma, &na, a, &lda) != 0 ) {
        printf("\n ERROR of array A reading\n");
        return 1;
      }
      if( GetArrayZ(in_file, &layout, GENERAL_MATRIX, &m, &n, b, &ldb) != 0 ) {
...
/*       Print input data                                      */
      ...
      PrintArrayZ(&layout, FULLPRINT, typeA, &ma, &na, a, &lda, "A");
      PrintArrayZ(&layout, FULLPRINT, GENERAL_MATRIX, &m, &n, b, &ldb, "B");

/*      Call CBLAS_ZTRMM subroutine ( C Interface )            */

      cblas_ztrmm(layout, side, uplo, transA, diag, m, n,
                  &alpha, a, lda, b, ldb);
