...
/*       Get input data                                        */
      ...
      if( GetVectorS(in_file, 5, param, 1) != 5 ) {
      ...
      x    = (double *)mkl_calloc(len_x, sizeof( float ), 64);
      y    = (double *)mkl_calloc(len_y, sizeof( float ), 64);
      if( x == NULL || y == NULL ) {
...
/*       Print input data                                      */
      ...
      printf("\n     INPUT DATA");
      printf("\n       N=%d", n);
      PrintVectorS(SHORTPRINT, 5, param, 1, "PARAM");
