...
/*
!  Content:
!      C B L A S _ C G E M M T  Example Program Text ( C Interface )
!******************************************************************************/
...
int main(int argc, char *argv[])
{
      ...
      printf("\n     C B L A S _ C G E M M T  EXAMPLE PROGRAM\n");
...
/*      Call CBLAS_CGEMMT subroutine ( C Interface )           */

      cblas_cgemmt(layout, uplo, transA, transB, n, k, &alpha, a, lda,
                   b, ldb, &beta, c, ldc);
