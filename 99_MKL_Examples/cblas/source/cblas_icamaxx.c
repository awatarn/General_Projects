...
/*
!  Content:
!      C B L A S _ I C A M A X   Example Program Text ( C Interface )
!******************************************************************************/
...
int main(int argc, char *argv[])
{
      ...
      printf("\n     C B L A S _ I C A M A X  EXAMPLE PROGRAM\n");
...
/*      Call CBLAS_ICAMAX subroutine ( C Interface )            */

      index = cblas_icamax(n, x, incx);
