...
/*
!  Content:
!      C B L A S _ Z T R S M  Example Program Text ( C Interface )
!******************************************************************************/
...
int main(int argc, char *argv[])
{
      ...
      printf("\n     C B L A S _ Z T R S M  EXAMPLE PROGRAM\n");
...
/*      Call CBLAS_ZTRSM subroutine ( C Interface )            */

      cblas_ztrsm(layout, side, uplo, transA, diag, m, n,
                  &alpha, a, lda, b, ldb);
