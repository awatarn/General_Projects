...
/*
!  Content:
!      C B L A S _ Z G E M M T  Example Program Text ( C Interface )
!******************************************************************************/
...
int main(int argc, char *argv[])
{
      ...
      printf("\n     C B L A S _ Z G E M M T  EXAMPLE PROGRAM\n");
...
/*      Call CBLAS_ZGEMMT subroutine ( C Interface )           */

      cblas_zgemmt(layout, uplo, transA, transB, n, k, &alpha, a, lda,
                   b, ldb, &beta, c, ldc);
