...
/*
!  Content:
!      C B L A S _ Z G E M M _ B A T C H  Example Program Text ( C Interface )
!******************************************************************************/
...
int main(int argc, char *argv[])
{
      ...
      printf("\n     C B L A S _ Z G E M M _ B A T C H  EXAMPLE PROGRAM\n");
...
/*      Call ZGEMM_BATCH subroutine ( C Interface )                  */
