...
/*
!  Content:
!      C B L A S _ Z G E R U  Example Program Text ( C Interface )
!******************************************************************************/
...
int main(int argc, char *argv[])
{
      ...
      printf("\n     C B L A S _ Z G E R U   EXAMPLE PROGRAM\n");
...
/*       Get input data                                       */
      ...
      if( GetVectorZ(in_file, m, x, incx) != len_x ) {
      ...
      if( GetArrayZ(in_file, &layout, GENERAL_MATRIX, &m,  &n,  a, &lda) != 0 ) {
