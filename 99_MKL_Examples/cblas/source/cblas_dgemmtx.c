...
/*
!  Content:
!      C B L A S _ D G E M M T  Example Program Text ( C Interface )
!******************************************************************************/
...
int main(int argc, char *argv[])
{
      ...
      printf("\n     C B L A S _ D G E M M T  EXAMPLE PROGRAM\n");
...
/*      Call CBLAS_DGEMMT subroutine ( C Interface )           */

      cblas_dgemmt(layout, uplo, transA, transB, n, k, alpha, a, lda,
                   b, ldb, beta, c, ldc);
