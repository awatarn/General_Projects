...
/*
!  Content:
!      C B L A S _ C G T H R  Example Program Text ( C Interface )
!******************************************************************************/
...
int main(int argc, char *argv[])
{
      ...
      printf("\n     C B L A S _ C G T H R  EXAMPLE PROGRAM\n");
...
/*      Call CBLAS_CGTHR subroutine ( C Interface )            */

      cblas_cgthr(n, y, x, indx);
