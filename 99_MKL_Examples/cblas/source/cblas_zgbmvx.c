...
/*
!  Content:
!      C B L A S _ Z G B M V  Example Program Text ( C Interface )
!******************************************************************************/
...
int main(int argc, char *argv[])
{
      ...
      printf("\n     C B L A S _ Z G B M V  EXAMPLE PROGRAM\n");
...
/*       Get input data                                       */
      ...
      lda=rmaxa;
      if( GetBandArrayZ(in_file, &layout, kl, ku, m, n, a, lda) != 0 ) {
...
/*       Print input data                                      */
      ...
      PrintBandArrayZ(&layout, FULLPRINT, kl, ku, m, n, a, lda, "A");

/*      Call CBLAS_ZGBMV subroutine ( C Interface )            */
